...
class TestAzureKeyVaultClient:
    ...
    def test_authenticate_success(self, mock_azure):
        ...
        with patch.object(mock_azure, "DefaultAzureCredential", return_value=mock_credential):
            with patch.object(mock_azure, "SecretClient", return_value=mock_secret_client):
                client = mock_azure.AzureKeyVaultClient(vault_url="https://test.vault.azure.net")
                client.authenticate()
    ...
    def test_list_secrets_with_prefix(self, mock_azure):
        ...
        mock_secret_client.list_properties_of_secrets.return_value = iter([mock_prop1, mock_prop2, mock_prop3])
